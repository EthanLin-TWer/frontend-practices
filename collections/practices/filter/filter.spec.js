...
describe('chooseMultiplesOfThree', function() {
...
describe('chooseNoRepeatNumber', function() {
  const collection = [1, 1, 1, 2, 2, 3, 4]

  it.skip('从collection中选出不重复的数字', function() {
...
describe('groupingCount', function() {
  const collection = [1, 1, 1, 1, 2, 3, 1, 3, 4, 2, 3, 1, 3, 4, 2]

  it.skip('从collection中计算出每个数的个数', function() {
...
describe('chooseCommonElements', function() {
...
describe('chooseNoCommonElements', function() {
  const collection_a = ['a', 'e', 'h', 't', 'f', 'c', 'g', 'b', 'd']
  const collection_b = ['a', 'd', 'e', 'f']

  it.skip('选出A集合中与B集合中的不共有元素', function() {
...
describe('chooseDivisibleInteger', function() {
